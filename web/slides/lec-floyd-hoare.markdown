...
$$\frac{ <\sigma,p> \Downarrow false }{ <\sigma, \texttt{assert}(p)> \Downarrow \texttt{crash} }$$

$$\frac{ <\sigma,p> \Downarrow true }{ <\sigma, \texttt{assert}(p)> \Downarrow \sigma` }$$

$$\frac{ <\sigma,p> \Downarrow true }{ <\sigma, \texttt{assume}(p)> \Downarrow \sigma` }$$
